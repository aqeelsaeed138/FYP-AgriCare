...
class SignupEnterOtpScreen extends StatefulWidget {
  const SignupEnterOtpScreen({super.key});
  @override
  State createState() => _SignupEnterOtpScreenState();
}

class _SignupEnterOtpScreenState extends State<SignupEnterOtpScreen> {
